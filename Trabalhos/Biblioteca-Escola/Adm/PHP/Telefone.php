<?php
    if(isset($_GET["txtNome"])){
        ...
        $oCon.the_library = mysqli_connect('localhost', 'root', '', '.library');
        ...
        mysqli_query($oCon.the_library, $oComInsertCep);
        mysqli_query($oCon.the_library, $oComInsertTelefone);
        mysqli_query($oCon.the_library, $oComInsertCliente);

        mysqli_close($oCon.the_library);
    }
?>
